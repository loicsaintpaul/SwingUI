...
public class AddClient {
	...
	private void initialize() {
		...
		lblCreer.setIcon(new ImageIcon(AddClient.class.getResource("/resources/images/outline_done_white_24dp.png")));
		lblCreer.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				try {
					...
					Client client = new Client(nom, prenom, ageInt, ville);
		...
		lblQuitter
				.setIcon(new ImageIcon(AddClient.class.getResource("/resources/images/outline_cancel_white_24dp.png")));
