...
public class UpdateCategorie {
	...
	private void initialize() {
		...
		lblCreer.setIcon(
				new ImageIcon(UpdateCategorie.class.getResource("/resources/images/outline_done_white_24dp.png")));
		lblCreer.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				try {
					...
					JOptionPane.showMessageDialog(frame, "Categorie modifiee");
					frame.setVisible(false);
					parent.setVisible(true);
				} catch (NumberFormatException ex) {
					JOptionPane.showMessageDialog(frame, "Mauvaise saisie");
				}
			}
		});
		...
		lblQuitter.setIcon(
				new ImageIcon(UpdateCategorie.class.getResource("/resources/images/outline_cancel_white_24dp.png")));
